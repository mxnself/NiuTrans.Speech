...
public:
    ...
    /* masks for timestamp rules */
    XTensor timestampMask;
    XTensor nonTimestampMask;
    XTensor contentMask;
...
public:
    ...
    void SetSpecialID(int sos, int eos, int pad, int unk, int numLanguage=-1);

    /* set masks for suppress tokens */
    void InitMask(int devID);
    ...
    string DecodingWord(vector<int>* tokensId);
