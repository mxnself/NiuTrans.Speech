...
public:
    ...
    /* run decoding for inference with pre-norm and non-autoregressive decoding*/
    XTensor RunFastNarPreNorm(XTensor& outputEnc, XTensor* maskEncDec, XTensor& outputPre, XTensor* maskPreDec);
};
