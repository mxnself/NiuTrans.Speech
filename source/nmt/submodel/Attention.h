...
#include "../../niutensor/tensor/function/Softmax.h"
using namespace nts;
...
{
/* attention type */
enum class ATTN_TYPE {SELF_ATT, EN_DE_ATT};
...
{
private:
    // it takes time to rewrite the whole class, therefore just keep it non-constant...
    ATTN_TYPE attType;
public:
    ...
    /* transformation matrix for QKV */
    XTensor weightFusion;
...
public:
    ...
    void InitModel(NMTConfig& config, bool isEnc, bool isSelfAtt, bool isFusion = false);
